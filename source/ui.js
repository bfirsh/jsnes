        ...
        $.fn.JSNESUI = function(roms) {
            ...
            var UI = function(nes) {
                ...
                self.buttons = {
                    ...
                    save: $('<input type="button" value="save" class="nes-load">').appendTo(self.controls),
                    load: $('<input type="button" value="load" class="nes-save">').appendTo(self.controls)
                };
            ...
            UI.prototype = {
                loadROM: function() {
                    return this.loadSpecificROM(this.romSelect.val());
                },
                loadSpecificROM: function(romPath) {
                    var self = this;
                    self.currentRom = romPath;
