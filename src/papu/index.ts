...
import ChannelDM from "./channel-dm.ts";
import ChannelNoise from "./channel-noise.ts";
import ChannelSquare from "./channel-square.ts";
import ChannelTriangle from "./channel-triangle.ts";
